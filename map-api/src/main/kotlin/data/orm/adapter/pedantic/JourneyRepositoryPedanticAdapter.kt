...
class JourneyRepositoryPedanticAdapter(
    ...
    private val lineVersionRepositoryPedanticAdapter: LineVersionRepositoryPedanticAdapter,
    private val routeRepositoryPedanticAdapter: RouteRepositoryPedanticAdapter,
): JourneyRepository {
    ...
    fun toDb(journey: Journey, relationalId: Long?): DbJourney {
        ...
        val dbJourney = DbJourney(
            ...
            lineVersion = lineVersionRepositoryPedanticAdapter.findSaveMapping(journey.lineVersion),
            route = journey.route?.let(routeRepositoryPedanticAdapter::findSaveMapping),
            schedule = schedule,
